...
const miniGames = [
  {
    id: '1',
    name: 'Bitcoin Blast',
    description: 'Match-3 puzzle game with Bitcoin rewards',
    url: 'https://bitcoinblast.app',
    icon: Zap,
  ...
  },
  {
    id: '2',
    name: 'Crypto Runner',
    description: 'Endless runner collecting crypto coins',
    url: 'https://cryptorunner.io',
    icon: Target,
  ...
  },
  {
    id: '3',
    name: 'Block Breaker',
    description: 'Classic arcade game with blockchain twist',
    url: 'https://blockbreaker.game',
    icon: Gamepad2,
